...
public class Material extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmbMaterial.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Kayu", "Baja", "Plastik", "Alumunium", "Bambu", "Porselen", "Kuningan", "Busa" }));
        cmbMaterial.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cmbMaterialMouseClicked(evt);
            }
        });
    ...
    private void cmbMaterialMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmbMaterialMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbMaterialMouseClicked

    private void cmbMaterialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMaterialActionPerformed
        // TODO add your handling code here:
        String dicari = cmbMaterial.getSelectedItem().toString();
        loadData(dicari);
